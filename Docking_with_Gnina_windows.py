...
#!curl -L -o gnina.fix https://github.com/gnina/gnina/releases/download/v1.3/gnina.fix

subprocess.run(['curl', '-L', '-o', 'gnina.fix', 'https://github.com/gnina/gnina/releases/download/v1.3/gnina.fix'], shell=True)
...
# Rename the file
shutil.move("gnina.fix", "gnina.exe")  # Add .exe if it's a Windows binary

# Make it executable (not needed on Windows, but safe to include)
os.chmod("gnina.exe", 0o755)
...
print("Ligands have been successully docked!")
