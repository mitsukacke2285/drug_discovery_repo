...
get_ipython().run_cell_magic('capture', '', "!pip install useful_rdkit_utils py3Dmol rdkit # If this command doesn't work, run each command separately\n!apt install openbabel\n")
...
get_ipython().system('pip install useful_rdkit_utils')


# In[ ]:


get_ipython().system('curl -L -O https://raw.githubusercontent.com/MolSSI-Education/iqb-2025/main/util.py')
...
get_ipython().system('wget https://github.com/gnina/gnina/releases/download/v1.3/gnina.fix')
...
get_ipython().system('mv gnina.fix gnina')
...
# Run gnina
get_ipython().system('mkdir molecular_docking/docking_results')
